...
const BusManagementPage = () => {
  ...
  // ✅ Effect phụ để cập nhật lại text khi ngôn ngữ thay đổi (không fetch lại API)
  useEffect(() => {
    if (schedules.length > 0) {
      setBusData(transformDataForDisplay(schedules));
    }
  }, [language, schedules, transformDataForDisplay]);
